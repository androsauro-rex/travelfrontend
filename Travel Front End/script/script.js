document.addEventListener('DOMContentLoaded', () => {
  ...
  const btnRC = document.querySelector(".link-itinerario-c");
  if (btnRC) {
  ...
  const btnM = document.querySelector(".link-itinerario-m");
  if (btnM) {
  ...
  navStyle.textContent = `.nav-link.active { color: #ff6b35; border-bottom-color: #ff6b35; }`;
